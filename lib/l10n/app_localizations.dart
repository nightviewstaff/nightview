...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'An error occurred while we were trying to log you in automatically. You may have changed your password since last time.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Shall wego out and party like never before tonight?'**
  ...
  /// Message indicating the location is open for one more hour
  ///
  /// In en, this message translates to:
  /// **'open {hours} more hour'**
  String open_one_more_hour(Object hours);

  /// Message indicating the location is open for multiple more hours
  ///
  /// In en, this message translates to:
  /// **'open {hours} more hours'**
  ...
  /// Message shown while fetching remaining locations in the background
  ///
  /// In en, this message translates to:
  ...
  /// Title for the favorites section in the side sheet
  ///
  /// In en, this message translates to:
  /// **'Favorites'**
  String get favorites_title;

  /// Shows the number of favorite clubs out of the maximum allowed
  ///
  /// In en, this message translates to:
  /// **'{count}/{max}'**
  String favorite_clubs_count(Object count, Object max);

  /// Error message when fetching favorite clubs fails
  ///
  /// In en, this message translates to:
  /// **'Error fetching favorite clubs'**
  String get error_fetching_favorite_clubs;

  /// Message shown when there are no favorite clubs
  ///
  /// In en, this message translates to:
  /// **'No favorite clubs yet'**
  String get no_favorite_clubs_yet;

  /// Title for the friends in town section in the side sheet
  ///
  /// In en, this message translates to:
  /// **'Friends in town'**
  ...
  /// Error message when fetching friends fails
  ///
  /// In en, this message translates to:
  /// **'Error fetching friends'**
  String get error_fetching_friends;

  /// Message shown when there are no friends in town
  ///
  /// In en, this message translates to:
  /// **'No friends in town'**
  String get no_friends_in_town;

  /// Title for the city right now section in the side sheet
  ///
  /// In en, this message translates to:
  /// **'City right now'**
  String get city_right_now_title;

  /// Message shown when there are no clubs active at the moment
  ///
  /// In en, this message translates to:
  /// **'No clubs active right now'**
  String get no_clubs_active_now;

  /// Shows the number of guests in a club
  ///
  /// In en, this message translates to:
  /// **'{count} guests'**
  ...
  /// Name of the city Copenhagen
  ///
  /// In en, this message translates to:
  /// **'Copenhagen'**
  String get location_copenhagen;

  /// Name of the city Aarhus
  ///
  /// In en, this message translates to:
  /// **'Aarhus'**
  String get location_aarhus;

  /// Name of the city Odense
  ///
  /// In en, this message translates to:
  /// **'Odense'**
  String get location_odense;

  /// Name of the city Aalborg
  ///
  /// In en, this message translates to:
  /// **'Aalborg'**
  String get location_aalborg;

  /// Name of the city Vejle
  ///
  /// In en, this message translates to:
  /// **'Vejle'**
